<template>
  ...
  <svg class="fill-current h-32 w-32 text-yellow-300" height="20" viewBox="0 0 32 32"
       width="20">
    <path
    ...
    <path d="M23.071 5.929H27.071V7.929H23.071z"
          transform="rotate(-45 25.077 6.931)"></path>
